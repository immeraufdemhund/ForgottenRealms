        ...
        do
        {
            ...
            switch (inputKey)
            {
                ...
                case 'E':
                    ...
                    if (money_on_ground == true)
                    {
                        DisplayDriver.press_any_key("As you Leave the Shopkeeper says, \"Excuse me but you have Left Some Money here.\"  ", true, 10, TextRegion.NormalBottom);
                        DisplayDriver.press_any_key("Do you want to go back and get your Money?", false, 15, TextRegion.NormalBottom);
