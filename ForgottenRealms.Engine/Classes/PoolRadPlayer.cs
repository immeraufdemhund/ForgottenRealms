...
public class PoolRadPlayer
{
        ...
        : this()
    {
        ...
        Array.Copy(data, 0x33, field_33, 0, 0x38);

        field_6B = data[0x6B];
        field_6C = data[0x6C];
        Array.Copy(data, 0x6D, saveVerse, 0, 5);
        field_72 = data[0x72];
        field_73 = data[0x73];
        field_74 = data[0x74];
        field_75 = data[0x75];
        field_76 = data[0x76];
        Array.Copy(data, 0x77, field_77, 0, 8);
        field_83 = data[0x83];
        field_84 = data[0x84];
        field_85 = data[0x85];
        field_86 = data[0x86];
        field_87 = data[0x87];
        Array.Copy(data, 0x96, field_96, 0, 8);
        ...
        field_B0 = data[0xB0];
        field_B1 = data[0xB1];
        Array.Copy(data, 0xB2, field_B2, 0, 3);
        Array.Copy(data, 0xB5, field_B5, 0, 3);
        ...
        field_BE = data[0xBE];
        field_C0 = data[0xC0];
        Array.Copy(data, 0xC1, field_C1, 0, 6);
