...
public class ovr031
{
    ...
    private const int Column_D = 4; // word_16E0E
    private const int Column_E = 2; // word_16E10
    private const int Column_F = 7; // word_16E12
    private const int Column_G = 2; // word_16E14
    private const int Column_H = 0; // word_16E16
    private const int Column_I = 9; // word_16E18
    private const int Column_J = 5; // word_16E1A
    private const int Row_A = 4; // byte_16E1C
    private const int Row_B = 3; // byte_16E1E
    private const int Row_C = 3; // byte_16E20
    private const int Row_D = 3; // byte_16E22
    private const int Row_E = 1; // byte_16E24
    private const int Row_F = 1; // byte_16E26
    private const int Row_G = 1; // byte_16E28
    private const int Row_H = 0; // byte_16E2A
