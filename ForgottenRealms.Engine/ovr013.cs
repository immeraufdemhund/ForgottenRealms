...
internal class ovr013
{
	...
	private static void AvoidMissleAttack(int percentage, Player player) // sub_3AF06
	{
	...
	private static System.Collections.Generic.Dictionary<Affects, affectDelegate> affect_table;
